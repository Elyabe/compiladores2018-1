...
//	private String nome;      // nome do identificador
	...
	private boolean isUtilizada; //atributo utilizado para verificar o warning de utiliza��o
	...
	public boolean getIsUtilizada() {
		return isUtilizada;
	}

	public void setIsUtilizada(boolean status) {
		this.isUtilizada = status;
	}
}
